    ...
    <div className={styles.main}>
      ...
      >
        ...
        {status === 'error' && loginType === 'account' && !submitting && (
          <LoginMessage
            content={intl.formatMessage({
              ...
              defaultMessage: 'Wrong Email or Password（admin/ant.design)',
            })}
          />
        )}
        {type === 'account' && (
        ...
        {status === 'error' && loginType === 'mobile' && !submitting && (
          <LoginMessage content="Wrong Authentication Code" />
        )}
        {type === 'mobile' && (
          <>
            {/* <ProFormText
      ...
      <Space className={styles.other}>
        <FormattedMessage id="pages.login.loginWith" defaultMessage="Other Signin Options" />
